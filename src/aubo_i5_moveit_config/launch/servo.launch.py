...
用法：
  ros2 launch aubo_i5_moveit_config servo.launch.py
  ros2 launch aubo_i5_moveit_config servo.launch.py auto_start:=false
"""
...
def generate_launch_description():
    ...
    servo_params = load_servo_params("aubo_i5_moveit_config", "config/servo.yaml")
