...
void ArmController::initialize()
{
    ...
    set_preset_pose_service_ = node_->create_service<robot_interfaces::srv::SetPresetPose>(
        "/arm/set_preset_pose",
        std::bind(&ArmController::handleSetPresetPose, this, std::placeholders::_1, std::placeholders::_2));
...
void ArmController::handleSetPresetPose(
    ...
    std::shared_ptr<robot_interfaces::srv::SetPresetPose::Response> response)
{
    ...
    response->success = moveToNamedTarget(request->preset_name);
}
